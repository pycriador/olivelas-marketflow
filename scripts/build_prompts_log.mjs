...
const rawPrompts = JSON.parse(fs.readFileSync('scripts/all_prompts.json', 'utf8'));

let content = `# 📜 Histórico Completo de Prompts, Evolução e Resultados do Projeto
...
fs.writeFileSync('docs/PROMPTS_AND_EVOLUTION_LOG.md', content, 'utf8');
console.log('[OK] Criado docs/PROMPTS_AND_EVOLUTION_LOG.md com sucesso!');
