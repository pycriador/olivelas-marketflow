    ...
    <div className="space-y-6">
            ...
            groups={[
              {
                ...
                options: [
                  { id: '10', label: '10 fornecedores por página' },
                  { id: '20', label: '20 fornecedores por página' },
                  { id: '30', label: '30 fornecedores por página' },
                ],
              },
              {
                id: 'status',
      ...
      {filtered.length === 0 ? (
        <EmptyState
          ...
          description="Ajuste os filtros de pesquisa ou cadastre um novo fornecedor parceiro."
        ...
        <div className="rounded-lg border bg-card shadow-sm overflow-hidden">
            ...
            <table className="w-full text-left text-sm">
              <thead className="border-b bg-muted/50 text-xs font-semibold uppercase text-muted-foreground">
                <tr>
                  ...
                  <th className="p-4">Canais de Comunicação</th>
                ...
                {paginatedSuppliers.map(sup => (
                  <tr key={sup.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="p-4 text-xs font-medium text-foreground">
                      {sup.contact_name || 'Contato Comercial'}
                    </td>
                    <td className="p-4">
                      <div className="space-y-1 text-xs text-muted-foreground">
                        ...
                        {sup.phone && (
                          <div className="flex items-center">
                            <Phone className="mr-1.5 h-3.5 w-3.5 shrink-0 text-primary" />
                            <span>{sup.phone}</span>
                          </div>
                        )}
                        {sup.email && (
                        ...
                        {!sup.whatsapp && !sup.phone && !sup.email && <span>Sem canais cadastrados</span>}
                      </div>
                    </td>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 border-t bg-muted/20 text-sm">
            <div className="text-xs text-muted-foreground">
              ...
              <span className="font-semibold text-foreground">{totalItems}</span> fornecedores
            </div>
